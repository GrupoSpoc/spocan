...
public class Initiative {
    ...
    public static Initiative convertJson(String jsonToTransform) throws ParseJsonException {
        try {
            ...
            // final boolean isFromCurrentUser = jsonObject.getBoolean("is_from_current_user");
            final boolean isFromCurrentUser = nickname.equalsIgnoreCase("nei"); // todo reemplazar por linea superior
